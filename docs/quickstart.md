...
3. Config initiale : WAN sur DHCP, LAN sur 192.168.1.1/24
...
DNS: 192.168.1.10 (AdGuard Home sur Raspberry Pi)
```

**Validation** :
- Web UI accessible sur https://192.168.1.1
...
3. IP statique : 192.168.1.2

**Config de base** :
```bash
# Via SSH sur 192.168.1.2
...
**Validation** :
- Web UI accessible : https://192.168.1.2:8006
- Storage configuré
- Updates installés
...
# Accéder aux UIs
# Homepage : http://192.168.1.10:3000
# Grafana : http://192.168.1.10:3001
# AdGuard : http://192.168.1.10:3002
```
